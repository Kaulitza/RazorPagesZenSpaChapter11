...
namespace RazorPages.Migrations
{
    ...
    [Migration("20201011020411_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 10, 22, 4, 10, 845, DateTimeKind.Local).AddTicks(6004),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2020, 10, 10, 22, 4, 10, 850, DateTimeKind.Local).AddTicks(2354),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 10, 22, 4, 10, 850, DateTimeKind.Local).AddTicks(2430),
                            ServicesID = 5
                        });
                });
